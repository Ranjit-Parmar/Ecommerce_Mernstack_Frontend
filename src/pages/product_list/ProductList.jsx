                        ...
                        <div className={`${filterModel ? "absolute" : "hidden"} z-20 lg:z-0 w-full top-0 left-0  lg:static lg:w-[25%] lg:flex flex-col justify-start gap-4 mt-5 lg:mt-0 pt-3 lg:bg-white bg-slate-100`}>
                            ...
                            <div className=' pl-3'>
                             ...
                             items-center gap-3'><label htmlFor="tshirt" className='h-full'><input type="checkbox" id='tshirt' value='tshirt' onClick={(e) => { categoryHandler(e) }} className='mr-4' />T-Shirts</label></li>
                                    <li className='p-3 flex justify-start
                             items-center gap-3'><label htmlFor="bottomwear" className='h-full'><input type="checkbox" id='bottomwear' value='bottomwear' onClick={(e) => { categoryHandler(e) }} className='mr-4' />Bottom wear</label></li>
                                    <li className='p-3 flex justify-start
                             items-center gap-3'><label htmlFor="topwear" className='h-full'><input type="checkbox" id='topwear' value='topwear' onClick={(e) => { categoryHandler(e) }} className='mr-4' />Topwear</label></li>
                                </ul>
                            </div>
                            <hr />
                            <div className=' pl-3'>
