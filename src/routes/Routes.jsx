...
const router = createBrowserRouter([
  {
    ...
    children: [
      { path: '', element: <Home /> },
      { path: '/shopcategory/:gender', element: <ShopCategory /> },
      { path: '/productlist', element: <ProductList /> },
      { path: '/productdetail/:id', element: <Product /> },
      { path: '/cart', element: <Cart /> },
      { path: '/checkout/address', element: <Address /> },
      { path: '/checkout/address/order-summery', element: <OrderSummery /> },
      ...
      { path: '/payment_success', element: <OrderSuccess /> },
      { path: '/payment_fail', element: <OrderCancel /> },
    ],
  },
  {
    path: '/login',
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'create-coupon', element: <Add_Edit_Coupon /> },
      { path: 'update-product/:id', element: <UpdateProduct /> },
      { path: 'update-coupon/:id', element: <Add_Edit_Coupon /> },
      { path: 'edit-profile', element: <EditProfile /> },
      { path: 'edit-admin-profile/:id', element: <EditAdminProfile /> },
